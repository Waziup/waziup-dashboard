  ...
  render() {
    ...
    return (
      <Card className="longCard">
        ...
        />
        <ActuatorForm
          modalOpen={this.state.modalAddActuator}
          handleClose={() => {
        ...
        <Grid container direction="row" justify="flex-start" spacing={24}>
          ...
          <Grid item md={12} lg={6}>
            <Typography>
              ...
              this.props.permission.scopes.includes("devices:delete") ? (
                <div className="cardTitleIcons">
                  <Hidden mdUp implementation="css">
                    <DeleteIcon
                      onClick={() => {
                        if (window.confirm(this.deleteMsg))
              ...
              this.props.settings.allowManualCreateResources ? (
                <div className="cardTitleIcons">
                  <Hidden mdUp implementation="css">
                    <AddCircleIcon
                      onClick={() => {
                        this.setState({ modalAddActuator: true });
                      }}
                    />
                  </Hidden>
                  <Hidden smDown implementation="css">
              ...
              this.props.settings.allowManualCreateResources ? (
                <div className="cardTitleIcons">
                  <Hidden mdUp implementation="css">
                    <AddCircleIcon
                      onClick={() => {
                        this.setState({ modalAddSensor: true });
                      }}
                    />
                  </Hidden>
                  <Hidden smDown implementation="css">
          ...
          <div className="boardIcon">
            ...
            <pre>
              ...
              {device.owner
                ? "owner: " +
                  device.owner +
                  (this.props.user && device.owner == this.props.user.username
                    ? " (you)"
                    : "")
                : ""}{" "}
            </pre>
            <pre>
              {" "}
              {"visibility: " +
                (device.visibility ? device.visibility : "public")}{" "}
            </pre>
