                ...
                (<div className="cardTitleIcons">
                  ...
                  <Hidden smDown implementation="css">
                    <Button className="topRightButton"
                            variant="contained"
                            color="primary"
                            onTouchTap={() => { if (window.confirm(this.deleteMsg)) this.props.deleteDevice(device.id) }}>
                      Delete
                    </Button>
                  </Hidden>
                </div>) : null}
              {this.props.permission && this.props.permission.scopes.includes("devices:update") && this.props.settings.allowManualCreateResources ? 
                (<div className="cardTitleIcons">
                  <Hidden mdUp implementation="css">
                  ...
                  <Hidden smDown implementation="css">
                    <Button className="topRightButton"
                            variant="contained"
                            color="primary"
                            onTouchTap={() => { this.setState({ modalAddActuator: true }) }}>
                      Add actuator
                    </Button> 
                  </Hidden>
                </div>) : null}
                ...
                (<div className="cardTitleIcons">
                  ...
                  <Hidden smDown implementation="css">
                    <Button className="topRightButton"
                            variant="contained"
                            color="primary"
                            onTouchTap={() => { this.setState({ modalAddSensor: true }) }}>
                      Add sensor
                    </Button> 
                  </Hidden>
                </div>) : null}
