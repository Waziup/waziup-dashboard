        ...
        >
          <Toolbar>
            ...
            <a
              ...
              href={config.docDashboardUrl + "/#notifications"}
              target="_blank"
            >
...
function mapStateToProps(state) {
  return {
    ...
    devices: state.settings.showPublicResources
      ? state.devices.devices
      : state.devices.devices.filter(
          (d) => d.owner == state.current_user.username
        ),
    users: state.settings.showPublicResources
      ? state.users.users
      : [state.current_user],
  };
}
