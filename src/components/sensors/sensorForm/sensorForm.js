  ...
  componentDidMount() {
    if(!UTIL.objIsEmpty(this.props.formData)){
            this.setState({sensor:{
                ...
                "sensorMeasurement": UTIL.getMeasurements(this.props.formData)[0].key ? UTIL.getMeasurments(this.props.formData)[0].key : "",
            }})
     }
  }
  componentWillReceiveProps(nextProps){
     if(!UTIL.objIsEmpty(nextProps.formData)){
            this.setState({sensor:{
                ...
                "sensorMeasurement": UTIL.getMeasurements(nextProps.formData)[0].key ? UTIL.getMeasurements(nextProps.formData)[0].key : "",
            }})
    }
