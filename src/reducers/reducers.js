...
function deviceAttributesReducer(state = {isLoading: false, deviceAttributes: [], error: false, errMsg: ''}, action = null) {
  switch (action.type) {
    case types.GET_DEVICE_ATTRIBUTES_START:   return Object.assign({}, state, {isLoading: true,                                 error: false});
    case types.GET_DEVICE_ATTRIBUTES_SUCCESS: return Object.assign({}, state, {isLoading: false, deviceAttributes: action.data, error: false});
    case types.GET_DEVICE_ATTRIBUTES_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data,              error: true});
    default: return state;
  }
}

// Get all devices
function devicesReducer(state = {isLoading: false, devices: [], error: false, errMsg: ''}, action = null) {
  switch (action.type) {
    case types.GET_DEVICES_START:   return Object.assign({}, state, {isLoading: true, error: false});
    case types.GET_DEVICES_SUCCESS: return Object.assign({}, state, {isLoading: false, devices: action.data, error: false});
    case types.GET_DEVICES_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    default: return state;
  }
}

// Actions on one device
function deviceReducer(state = {isLoading: false, msg: {}, error: false}, action = null) {
  switch (action.type) {
    case types.CREATE_DEVICE_START:   return Object.assign({}, state, {isLoading: true });
    case types.CREATE_DEVICE_SUCCESS: return Object.assign({}, state, {isLoading: false, msg: action.data, error: false});
    case types.CREATE_DEVICE_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.GET_DEVICE_START:      return Object.assign({}, state, {isLoading: true });
    case types.GET_DEVICE_SUCCESS:    return Object.assign({}, state, {isLoading: false, device: action.data, error: false});
    case types.GET_DEVICE_ERROR:      return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.UPDATE_DEVICE_START:   return Object.assign({}, state, {isLoading: true });
    case types.UPDATE_DEVICE_SUCCESS: return Object.assign({}, state, {isLoading: false, msg: action.data, error: false});
    case types.UPDATE_DEVICE_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.DELETE_DEVICE_START:   return Object.assign({}, state, {isLoading: true });
    case types.DELETE_DEVICE_SUCCESS: return Object.assign({}, state, {isLoading: false, msg: action.data, error: false});
    case types.DELETE_DEVICE_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    default: return state;
  }
}
...
// Get all projects
function projectsReducer(state = {isLoading: false, projects: [], error: false, errMsg: ''}, action = null) {
  switch (action.type) {
    case types.GET_PROJECTS_START:   return Object.assign({}, state, {isLoading: true, error: false});
    case types.GET_PROJECTS_SUCCESS: return Object.assign({}, state, {isLoading: false, projects: action.data, error: false});
    case types.GET_PROJECTS_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    default: return state;
  }
}

// Get a project
function projectReducer(state = {isLoading: false, project: [], error: false, errMsg: ''}, action = null) {  
  switch (action.type) {
    case types.CREATE_PROJECT_START:   return Object.assign({}, state, {isLoading: true });
    case types.CREATE_PROJECT_SUCCESS: return Object.assign({}, state, {isLoading: false, msg: action.data, error: false});
    case types.CREATE_PROJECT_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.GET_PROJECT_START:      return Object.assign({}, state, {isLoading: true });
    case types.GET_PROJECT_SUCCESS:    return Object.assign({}, state, {isLoading: false, project: action.data, error: false});
    case types.GET_PROJECT_ERROR:      return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.UPDATE_PROJECT_START:   return Object.assign({}, state, {isLoading: true });
    case types.UPDATE_PROJECT_SUCCESS: return Object.assign({}, state, {isLoading: false, msg: action.data, error: false});
    case types.UPDATE_PROJECT_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.DELETE_PROJECT_START:   return Object.assign({}, state, {isLoading: true });
    case types.DELETE_PROJECT_SUCCESS: return Object.assign({}, state, {isLoading: false, msg: action.data, error: false});
    case types.DELETE_PROJECT_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    default: return state;
  }
}

// Get all devices attributes
function gatewayAttributesReducer(state = {isLoading: false, gatewayAttributes: [], error: false, errMsg: ''}, action = null) {
  switch (action.type) {
    case types.GET_GATEWAY_ATTRIBUTES_START:   return Object.assign({}, state, {isLoading: true, error: false});
    case types.GET_GATEWAY_ATTRIBUTES_SUCCESS: return Object.assign({}, state, {isLoading: false, gatewayAttributes: action.data, error: false});
    case types.GET_GATEWAY_ATTRIBUTES_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    default: return state;
  }
}

// Get all gateways
function gatewaysReducer(state = {isLoading: false, gateways: [], error: false, errMsg: ''}, action = null) {
  switch (action.type) {
    case types.GET_GATEWAYS_START:   return Object.assign({}, state, {isLoading: true, error: false});
    case types.GET_GATEWAYS_SUCCESS: return Object.assign({}, state, {isLoading: false, gateways: action.data, error: false});
    case types.GET_GATEWAYS_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    default: return state;
  }
}

// Get a gateway
function gatewayReducer(state = {isLoading: false, gateway: [], error: false, errMsg: ''}, action = null) {  
  switch (action.type) {
    case types.CREATE_GATEWAY_START:   return Object.assign({}, state, {isLoading: true });
    case types.CREATE_GATEWAY_SUCCESS: return Object.assign({}, state, {isLoading: false, msg: action.data, error: false});
    case types.CREATE_GATEWAY_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.GET_GATEWAY_START:      return Object.assign({}, state, {isLoading: true });
    case types.GET_GATEWAY_SUCCESS:    return Object.assign({}, state, {isLoading: false, gateway: action.data, error: false});
    case types.GET_GATEWAY_ERROR:      return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.UPDATE_GATEWAY_START:   return Object.assign({}, state, {isLoading: true });
    case types.UPDATE_GATEWAY_SUCCESS: return Object.assign({}, state, {isLoading: false, msg: action.data, error: false});
    case types.UPDATE_GATEWAY_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.DELETE_GATEWAY_START:   return Object.assign({}, state, {isLoading: true });
    case types.DELETE_GATEWAY_SUCCESS: return Object.assign({}, state, {isLoading: false, msg: action.data, error: false});
    case types.DELETE_GATEWAY_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    default: return state;
  }
}
...
// Get socials
function socialsReducer(state = {isLoading: false, socials: [], error: false, errMsg: ''}, action = null) {
  switch (action.type) {
    case types.GET_SOCIALS_START:   return Object.assign({}, state, {isLoading: true, error: false});
    case types.GET_SOCIALS_SUCCESS: return Object.assign({}, state, {isLoading: false, socials: (action.data).reverse(), error: false});
    case types.GET_SOCIALS_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    default: return state;
  }
}
...
// Actions on one device
function notificationReducer(state = {isLoading: false, msg: {}, error: false}, action = null) {
  switch (action.type) {
    case types.GET_NOTIF_START:      return Object.assign({}, state, {isLoading: true });
    case types.GET_NOTIF_SUCCESS:    return Object.assign({}, state, {isLoading: false, notification: action.data, error: false});
    case types.GET_NOTIF_ERROR:      return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
...
// Get all permissions
function permissionsReducer(state = {isLoading: false, device: [], project: [], gateway: [], error: false}, action = null) {
  switch (action.type) {
    case types.GET_PROJECT_PERMS_START:   return Object.assign({}, state, {isLoading: true });
    case types.GET_PROJECT_PERMS_SUCCESS: return Object.assign({}, state, {isLoading: false, project: action.data, error: false});
    case types.GET_PROJECT_PERMS_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.GET_DEVICE_PERMS_START:    return Object.assign({}, state, {isLoading: true });
    case types.GET_DEVICE_PERMS_SUCCESS:  return Object.assign({}, state, {isLoading: false, device: action.data, error: false});
    case types.GET_DEVICE_PERMS_ERROR:    return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    case types.GET_GATEWAY_PERMS_START:   return Object.assign({}, state, {isLoading: true });
    case types.GET_GATEWAY_PERMS_SUCCESS: return Object.assign({}, state, {isLoading: false, gateway: action.data, error: false});
    case types.GET_GATEWAY_PERMS_ERROR:   return Object.assign({}, state, {isLoading: false, msg: action.data, error: true});
    default: return state;
  }
}
